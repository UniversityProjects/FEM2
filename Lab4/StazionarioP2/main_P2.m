...
% ---------------------------
% Risolve il problema della diffusione stazionario
% Elementi P2 continui
% Sia al locale che al globale i GdL sono prima quelli associati 
% ... a tutti i vertici, poi quelli associati ai lati.
% ---------------------------
% Il carico e' dato nel file carico.m
% Soluzione esatta e derivata nel file exsol.m, exsolG.m
...
b = P2load(xv,yv,vertices,edges,boundary,boundedges,endpoints);
uh = A\b;
